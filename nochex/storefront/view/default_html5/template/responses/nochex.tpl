...
<form action="<?php echo $action; ?>" method="post" id="checkout">
	...
	<input type="hidden" name="xml_item_collection" value="<?php echo $xml_item_collection; ?>"/>		<input type="hidden" name="hide_billing_details" value="<?php echo $hide_billing_details; ?>"/>
	...
	<div class="control-group">
	    <div class="controls">
	    	<button class="btn btn-orange pull-right lock-on-click" title="<?php echo $button_confirm; ?>" type="submit">
